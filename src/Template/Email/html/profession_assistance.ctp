                	...
                	<tr>
                    	<td>
                        	<table style="width:90%;margin:0 auto;" cellpadding="15" cellspacing="0">
                                ...
                                <tr>
                                    <td style="font-family:'Open Sans', sans-serif;color:#64646e;font-size:14px;text-align:left;">Hi <?=$data['admin'];?>,</td>
                                </tr>
                                <tr>
                                    <td style="font-family:'Open Sans', sans-serif;color:#64646e;font-size:14px;text-align:left;">  <?php echo $data['message'];?></td>
                                </tr>
                                <tr>
