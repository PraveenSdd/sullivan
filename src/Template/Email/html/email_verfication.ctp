                	...
                	<tr>
                    	<td>
                        	<table style="width:90%;margin:0 auto;" cellpadding="15" cellspacing="0">
                                ...
                                <tr>
                                   <td align='center'><a href="<?= BASE_URL?>/users/emailVerification/<?php echo $data['token']; ?>" style="font-family:'Open Sans', sans-serif;color:#ffffff;font-size:14px;font-weight:600;background-color:#09347a;padding:10px 20px;border-radius:3px;text-decoration:none;width:auto;display:inline-block;margin:0 auto;"> Click for email verfication</a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
