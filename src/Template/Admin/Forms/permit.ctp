...
<!-- Permit Agency Block - START -->
                        <div class="row ">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                     <?php echo $this->Html->link('Add Agency','javascript:void(0);',array('escape' => false, 'data-title'=>"Agencies", 'class'=>"permitAgency  addicons ")); ?> 
...
<!-- Permit Document/Form Block - START -->
                        <div class="row">
                            <div class="form-group ">
                                ...
                                <div class="col-sm-3">
                                     <?php echo $this->Html->link('Add Forms','javascript:void(0);',array('escape' => false, 'data-title'=>"Permit Forms", 'class'=>"permitFormsModel  addicons ")); ?> 
...
<!-- Permit Attachment Block - START -->
                        <div class="row">
                            <div class="form-group ">
                                ...
                                <div class="col-sm-3">
                                    <?php echo $this->Html->link('Add Documents','javascript:void(0);',
                                            array('escape' => false,
...
<!-- Permit Deadline Block - START -->
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                 <?php echo $this->Html->link('Add Deadline','javascript:void(0);',array('escape' => false, 'data-title'=>"Permit Deadline", 'class'=>"permitDeadline  addicons ")); ?> 
...
<!-- Permit Alert Block - START -->
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <?php echo $this->Html->link('Add Alert','javascript:void(0);',array('data-formId'=>(@$form)? $form['id']:'','escape' => false, 'data-title'=>"Permit Alert", 'class'=>"permitAlert  addicons ")); ?> 
                           </div>
                                 </div> 
                        </div>
                   ...
                   <div class="row padding-top-10">
                                ...
                                <div class="row  view-permit-outer text-center">                    
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-3">
                                             <?php echo $this->Html->link('Add Instruction Document','javascript:void(0);',array('escape' => false, 'data-title'=>"Instruction Document", 'data-formId'=>'','class'=>"PermiInstruction addicons")); ?>                                           
                                        </div>
                                    </div>
                                </div>
                            </div>
