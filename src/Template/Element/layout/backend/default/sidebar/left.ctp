...
<aside class="main-sidebar" >
    <section class="sidebar">
     ...
     <?php echo $this->Html->link('<i class="fa fa-dashboard"></i> <span>Dashboard</span>',['controller'=>'users','action'=>'dashboard'],array('escape' => false)); ?>
            ...
            if($this->request->params['controller'] == 'Users' && ($this->request->params['action'] == 'profile' || $this->request->params['action'] == 'profileEdit' || $this->request->params['action'] == 'changePassword') || $this->request->params['controller'] == 'Staffs' && ($this->request->params['action'] == 'add' || $this->request->params['action'] == 'index' || $this->request->params['action'] == 'view'|| $this->request->params['action'] == 'edit')){ ?>  style="display: block;" <?php } ?>>
                ...
                <?= $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-key')).'Change Password', array('controller' => 'Users', 'action' => 'changePassword'), array('escape' => false)) ?>
                    ...
                    <li class=" <?php if($this->request->params['controller'] == 'Staffs' && ($this->request->params['action'] == 'add' || $this->request->params['action'] == 'index' || $this->request->params['action'] == 'view'|| $this->request->params['action'] == 'edit')){ ?> head-active active <?php }?>">
                         <?php echo $this->Html->link('<i class="fa fa-users"></i> <span>Manage Staffs</span>',['controller'=>'staffs','action'=>'index'],array('escape' => false)); ?>

                    </li>
                </ul>
            </li>
            <!--/* Manage Agencies */-->
            <li class=" <?php if($this->request->params['controller'] == 'agencies' &&  ($this->request->params['action'] == 'index' || $this->request->params['action'] == 'add' || $this->request->params['action'] == 'edit' || $this->request->params['action'] == 'view')){?> head-active active <?php }?>">

                  <?php echo $this->Html->link('<i class="fa fa-pie-chart"></i> <span>Manage Agencies</span>',['controller'=>'agencies','action'=>'index'],array('escape' => false)); ?>
            ...
            <!--/* Manage Permit */-->
            <li class=" <?php if($this->request->params['controller'] == 'permits' && ($this->request->params['action'] == 'index' || $this->request->params['action'] == 'permit' || $this->request->params['action'] == 'edit' || $this->request->params['action'] == 'view' || $this->request->params['action'] == 'upload')){ ?> head-active active <?php }?>">

                 <?php echo $this->Html->link('<i class="fa fa-file"></i> <span>Manage Permits</span>',['controller'=>'permits','action'=>'index'],array('escape' => false)); ?>
         ...
         <?php echo $this->Html->link('<i class="fa fa-bell"></i> <span>Manage Alerts</span>',['controller'=>'alerts','action'=>'index'],array('escape' => false)); ?>
            ...
            if($this->request->params['controller'] == 'HomePages' && ($this->request->params['action'] == 'index' || $this->request->params['action'] == 'edit' || $this->request->params['action'] == 'view' || $this->request->params['action'] == 'subscriptionPlans' || $this->request->params['action'] == 'editSubscriptionPlans'  || $this->request->params['action'] == 'viewSubscriptionPlans' ) || $this->request->params['controller'] == 'HowItWorks' && ($this->request->params['action'] == 'index' || $this->request->params['action'] == 'edit' || $this->request->params['action'] == 'view') || $this->request->params['controller'] == 'pageLabels'){ ?> active-parent <?php } ?>">
                <a href="javascript:void(0)" class="head-title">
                ...
                <ul class="treeview-menu" <?php 
            if($this->request->params['controller'] == 'HomePages' && ($this->request->params['action'] == 'index' || $this->request->params['action'] == 'edit' || $this->request->params['action'] == 'view' || $this->request->params['action'] == 'subscriptionPlans' || $this->request->params['action'] == 'editSubscriptionPlans'  || $this->request->params['action'] == 'viewSubscriptionPlans' ) || $this->request->params['controller'] == 'HowItWorks' &&  ($this->request->params['action'] == 'index' || $this->request->params['action'] == 'edit' || $this->request->params['action'] == 'view') || $this->request->params['controller'] == 'EmailTemplates' || $this->request->params['controller'] == 'PageLabels'){ ?> style="display: block;" <?php } ?>>
                    <!--/* Manage Home Title */-->   
                    <li class="<?php if($this->request->params['controller'] == 'HomePages' &&  ($this->request->params['action'] == 'index' || $this->request->params['action'] == 'edit' || $this->request->params['action'] == 'view')){?> active<?php }?>">
                    ...
                    <li class="<?php if($this->request->params['controller'] == 'HomePages' && ($this->request->params['action'] == 'subscriptionPlans' || $this->request->params['action'] == 'SubscriptionPlans' || $this->request->params['action'] == 'editSubscriptionPlans' || $this->request->params['action'] == 'viewSubscriptionPlans')){?> active<?php }?>">
                    ...
                    <li class="<?php if($this->request->params['controller'] == 'HowItWorks' &&  ($this->request->params['action'] == 'index' || $this->request->params['action'] == 'edit' || $this->request->params['action'] == 'view')){?> active<?php }?>">
                      <?php echo $this->Html->link('<i class="fa fa-circle-o"></i> <span>How It Works</span>',['controller'=>'HowItWorks','action'=>'index'],array('escape' => false)); ?>
                    </li>
                    <li class="<?php if($this->request->params['controller'] == 'EmailTemplates' &&  ($this->request->params['action'] == 'index' || $this->request->params['action'] == 'edit')){?> active<?php }?>">
                      <?php echo $this->Html->link('<i class="fa fa-circle-o"></i> <span>Email Templates</span>',['controller'=>'emailTemplates','action'=>'index'],array('escape' => false)); ?>
                    </li>
                    <li class="<?php if($this->request->params['controller'] == 'PageLabels' &&  ($this->request->params['action'] == 'index' || $this->request->params['action'] == 'edit')){?>active<?php }?>">
                      <?php echo $this->Html->link('<i class="fa fa-circle-o"></i> <span>Page Labels</span>',['controller'=>'pageLabels','action'=>'index'],array('escape' => false)); ?>
                    </li>
            ...
            <li class="<?php if($this->request->params['controller'] == 'ProfessionalAssistances' && ($this->request->params['action'] == 'index' || $this->request->params['action'] == 'view')){?> active<?php }?>">
                  ...
                  <?php echo $this->Html->link('<i class="fa fa-phone"></i> <span> Helps</span>',['controller'=>'professionalAssistances','action'=>'index'],array('escape' => false)); ?>
            </li>
